...
class PubsList(dict[DocumentId, dict[str, Any]]):
    ...
    def __enter__(self):
        self.unsubscribe = self.pub_collection.on_snapshot(self._pub_updater).unsubscribe
        return self
    ...
    def _pub_updater(self, doc_snapshot: DocumentSnapshot, changes: Sequence[DocumentChange], read_time: Datetime):
